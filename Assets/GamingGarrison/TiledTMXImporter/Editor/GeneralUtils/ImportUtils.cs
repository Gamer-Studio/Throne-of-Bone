    ...
    public class ImportUtils
    {
        ...
        public static T ReadXMLIntoObject<T>(string path)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("<b>Stopping due to validation mode finding something unrecognised by this version of TMX Importer - You can try with Data Validation Mode turned off to ignore warnings</b>");
                }
        ...
        {
            string assetsFolder = Application.dataPath; // Assets folder in editor
            Debug.Log("Full path = " + path);
            DirectoryInfo parent = Directory.GetParent(path);
            string parentPath = parent.ToString();
            parentPath = parentPath.Substring(assetsFolder.Length);
            ...
            {
                parentPath = "Assets" + Path.DirectorySeparatorChar + parentPath;
            }
            ...
            {
                Debug.Log("Could not create asset folder " + folderName + " at " + parentPath);
                return false;
            }
            return true;
        }
