...
namespace GamingGarrison
{
    public class TiledUtils
    {
        ...
        public static Vector2 TiledIsometricPixelToScreenSpace(Vector2 isometricSpacePos, Vector2 tilePixelWidthAndHeight)
        {
            ...
            Vector2 tileSpace = new Vector2(isometricSpacePos.x / tilePixelWidthAndHeight.y, -isometricSpacePos.y / (tilePixelWidthAndHeight.y * 2.0f));
        ...
        public static Vector2 TiledIsometricTileToScreenSpace(Vector2 isometricSpacePos, Vector2 tilePixelWidthAndHeight)
        {
            ...
            Vector2 tilePixelWidthHeightHalf = new Vector2(tilePixelWidthAndHeight.x * 0.5f, tilePixelWidthAndHeight.y * 0.5f);

            // Extra offset to bump it up half a cell (and since tiles are typically 2 tiles high, it's a quarter of tile height)
            Vector2 offset = new Vector2(0.0f, 0.25f);
            screenPos = Vector2.Scale(screenPos, tilePixelWidthHeightHalf) + offset; 
            return screenPos;
        }
    }
}
